...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['commentaire_en_cours'], $_POST['note_en_cours'], $_POST['id_covoiturage'], $_POST['id_chauffeur'])) {
    ...
    //Affichage des informations de l'utilisateur
            ...
            echo '<img src="../controllers/display_photo.php?id=' . htmlspecialchars($utilisateur['utilisateur_id']) . '" alt="Photo de ' . htmlspecialchars($utilisateur['pseudo']) . '" width="auto" height="300">';
            echo '</div>'; 
