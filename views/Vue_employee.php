    ...
    <body>
        ...
        if ($resultats_avis_en_cours){
            foreach ($resultats_avis_en_cours as $avis_en_cours) {
                ...
                echo "<strong>Commentaire:</strong> " . htmlspecialchars($avis_en_cours['commentaire_en_cours']) . "<br>";
                

                echo "<button class='button'>Valider</button>";
                echo "<button class='button'>Refuser</button>";
                echo "</div>";
            }
        }
